...
public class KanbanContextFactory : IDesignTimeDbContextFactory<KanbanContext>
{
    public KanbanContext CreateDbContext(string[] args)
    {
      ...
      public static void seed(KanbanContext context){
            ...
            var implementTask = new Task {Title = "Implement code",State = Assignment4.Core.State.Active, Tags = new[]{ImplementationTag}, StateUpdated = System.DateTime.UtcNow};
            var coffeeTask = new Task {Title = "Get Coffee",State = Assignment4.Core.State.Resolved, Tags = new[]{TbdTag, DiscussionTag}, StateUpdated = System.DateTime.UtcNow};
            var mcdTask = new Task {Title = "Get Mc Donalds",State = Assignment4.Core.State.New, Tags = new[]{TbdTag, DiscussionTag}, StateUpdated = System.DateTime.UtcNow};
            ...
            var drinkTask = new Task {Title = "Drik øl", State = Assignment4.Core.State.Active, Tags = new[]{BeerTag}, StateUpdated = System.DateTime.UtcNow};
            ...
            context.Users.Add(new User {Name = "Soma", Email = "Alsoma@gmail.com", Tasks = new[]{drinkTask}});   
            context.SaveChanges();
        } 
    }
